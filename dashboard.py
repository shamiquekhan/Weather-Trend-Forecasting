#!/usr/bin/env python3
"""
🌦️ Weather Trend Forecasting - Interactive Plotly Dash Dashboard
==================================================================
...
app.layout = html.Div(style=STYLE, children=[
    ...
    html.Div([
        ...
        html.P("PM Accelerator Mission: Empower the next generation of AI professionals through hands-on experience.",
    ...
    html.Div([
        html.Div([
            html.Label("🏙️  Select City:", style={"fontWeight": "700", "marginBottom": "10px"}),
            dcc.Dropdown(
                id="city-selector",
    ...
    # Footer
    html.Div([
        html.P("Built with Plotly Dash | PM Accelerator AI Engineer Assessment", 
...
def update_temp_chart(city, start_date, end_date):
    ...
    filtered = df[(df["location_name"] == city) & 
...
def update_model_comparison(city):
    ...
    fig = px.bar(metrics_df, x="Model", y="MAE", 
                ...
                template="plotly_dark", color_discrete_sequence=["#FF6B35", "#00d9ff"])
...
def update_monthly_heatmap(city):
    ...
    fig = px.imshow(pivot, labels=dict(x="Year", y="Month", color="Temp (°C)"),
                   ...
                   template="plotly_dark", color_continuous_scale="RdYlBu_r",
                   aspect="auto")
